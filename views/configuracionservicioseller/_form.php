...
$wizard_config = [
    ...
    'steps' => [
        1 => [
            ...
            'content' => Yii::$app->controller->renderPartial('seleccionar_servicio_step',['form'=>$form,'model'=>$model,'lista_servicios'=>$lista_servicios]),
            'skippable' => false,
            'buttons' => [
                'next' => [
                    'title' => 'Siguiente', 
        ...
        4 => [
            ...
            'icon' => 'glyphicon glyphicon-time',            
            'content' => Yii::$app->controller->renderPartial('seleccionar_horario_seller',['form'=>$form,'model'=>$model,'lista_horarios'=>$lista_horarios]),
            'skippable' => false,
            'buttons' => [
                'next' => [
                    'title' => 'Siguiente', 
